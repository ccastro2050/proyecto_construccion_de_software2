...
> el puerto 8043 (pasa al reiniciar el PC: la API vieja revive sin su
...
> ```
> NAMES                                               STATUS                    PORTS
> proyecto_construccion_de_software2-api-facturas-1   Up 2 hours                0.0.0.0:8043->8043/tcp
> proyecto_construccion_de_software2-postgres-1       Up 2 hours (healthy)      0.0.0.0:15443->5432/tcp
> ```
>
...
```powershell
git clone https://github.com/ccastro2050/proyecto_construccion_de_software2.git
cd proyecto_construccion_de_software2
...
```
proyecto_construccion_de_software2/
...
│
├── api_facturas/                # LA API DE LA v1 — C#/ASP.NET Core (puerto 8043)
...
│   ├── appsettings.json         # Cadena de conexión (default localhost:15443)
