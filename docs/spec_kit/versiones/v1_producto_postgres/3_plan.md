...
└── api_facturas/
    ...
    ├── Dockerfile                    # sdk:10.0 + dotnet watch (puerto 8043)
    ├── Modelos/
...
funcionando. En v1 eso son **dos servicios**: `postgres` (15443 al host,
se siembra solo) y `api-facturas` (8043, código montado +
